# ai-workstation — Official Context
...
- **Development Workflow** — `0.2.0-draft` — direct Source — Why: We want to use the same successful development workflow from context-canon for this project too. Feel free to use also other workflowss, if you like. Then put it here. — [inspect accepted carrier](.context/sources/67392242f1cc1e305607a19b8c82b1a3a5e9fbf7f85640af5f90daaf3a992653/CONTEXT.md)
